...
class Task_Getjsoncategories extends Minion_Task {
...
//		$uri = 'http://192.168.1.1/shop33/catalog/category0/category1';
		$uri = 'http://192.168.1.1/shop33/catalog';
		$uri = trim($uri); 
...
//			echo curl_error ( $curl );
			...
			foreach ($objs as $obj){
				Minion_CLI::write('get json -categori-- '.$obj->title);
